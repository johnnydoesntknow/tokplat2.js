...
const purchaseShares = async (assetId, shareAmount) => {
  ...
  useEffect(() => {
    ...
    const handleFractionsPurchased = (assetId, buyer, amount, totalCost) => {
    ...
    fractionalization.on('FractionsPurchased', handleFractionsPurchased);
    ...
    return () => {
      fractionalization.off('FractionsPurchased', handleFractionsPurchased);
